...
default = '\033[0m'
blue = '\033[34m'
statistics_table = PrettyTable([blue+'基金名称'+default,blue+'成本'+default,blue+'金额'+default,blue+'今日净值'+default,blue+'涨跌幅度'+default,blue+'今日收益'+default,blue+'总收益'+default,blue+'盈亏率'+default,blue+' 近期涨跌,'+six_days_ago+'到'+yesterday+default],align='l',width=100,reversesort=True)
...
def count_all_fund():
    ...
    for i in common_fund_info_content:
        ...
        statistics_table.add_row([fund_info['name'],count,amount,fund_info['gsz'],fund_info_gszzl_colour,today_revenue_colour,total_revenue_colour,profit_and_loss_ratio_colour,rise_fall])
...
def count_lof_fund(dict):
    ...
    statistics_table.add_row([dict['name'], count, amount,"--", "--", "--", total_revenue_colour,profit_and_loss_ratio_colour, rise_fall])
